...
$kml_file = '2009_skateboard_parks.kml';

// The name of the table to create in the SQL file
$table_name = 'skateboardparks2';
...
$output .= 'INSERT INTO `' . $table_name . '` (`name`, `lat` ,`longi`, ' . implode(', ', $fields) . ") VALUES\n";
$values = array();
