<?php 
/**
* A self-contained file that holds all the functions we need for the user authentication
*
...
function get_hashed_password ($password){
	...
	//It helps with security and Blowfish algorithm requires it
...
function user_sign_in($id){
	session_regenerate_id();  //to get a brand new id for user .. this is for security
	$_SESSION['id'] = $id;
